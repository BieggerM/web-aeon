...
<div class="container h-screen mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		...
		<div class="flex justify-center space-x-2 mx-2">
			<p class="text-xl">The linux desktop for people who want to "get stuff done".</p>
		</div>
...
<div class="container mx-auto mt-16">
	<div class="space-y-5 text-left flex flex-col">
		<Presentation
			...
			text="For a user-friendly and intuitive desktop experience, Aeon leverages the power of GNOME. GNOME is a popular and widely-used desktop environment known for its clean aesthetics, intuitive layout, and focus on user productivity. With GNOME, you'll enjoy a clutter-free workspace."
		/>
		<Presentation
